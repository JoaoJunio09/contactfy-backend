...
public class UserResponseAllDTO extends RepresentationModel<UserResponseAllDTO> implements Serializable {
    ...
    public UserResponseAllDTO() {}

    public UserResponseAllDTO(Long id, String email, PersonResponseDTO person) {
        this.id = id;
        this.email = email;
        this.person = person;
    }
    ...
    public boolean equals(Object o) {
        ...
        UserResponseAllDTO user = (UserResponseAllDTO) o;
